...
router.add('/products/alldiaries', async () => {
    const page = await import('/pages/Products/AllDiaries.js');
    return page.default();
});
...
router.add('/notebook-details/:id', async (params) => {
    const { id } = params;
    const page = await import('/pages/Products/Notebook-Details.js');
    return page.default(id);
});
router.add('/diary-details/:id', async (params) => {
    const { id } = params;
    const page = await import('/pages/Products/Diary-Details.js');
    return page.default(id);
});
