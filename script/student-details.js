document.addEventListener("DOMContentLoaded", function () {
    ...
    const url = `https://esyserve.top/search/student/${encodeURIComponent(studentId)}`;
    ...
    button.addEventListener('click', function () {
        ...
        (async function () {
            try {
                const response = await fetch(`https://esyserve.top/student/delete/${encodeURIComponent(studentId)}`, {
                    method: 'DELETE',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json'
