document.addEventListener("DOMContentLoaded", function () {
    ...
    const url = `https://esyserve.top/search/teacher/${encodeURIComponent(teacherId)}`;
    ...
    button.addEventListener('click', function () {
        ...
        (async function () {
            try {
                const response = await fetch(`https://esyserve.top/teacher/delete/${encodeURIComponent(teacherId)}`, {
                    method: 'DELETE',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json'
